...
--both of the above are taken from your code in 'Struct.lean' 
-- modified to allow powers

axiom powerlaw {G : Type} {Gr : Group G} (g : G) (n : ℕ) : 
  Gr.power_mul g n = 
    match n with
    | 0 => Gr.unit
    | n + 1 => Gr.mul g (Gr.power_mul g n)

--I've used an axiom here because this is a fundamental property of my
-- definition of group
